...
<head>
    ...
    <script>
        ...
        function startCountdown() {
            ...
            if (countdown > 0) {
                countdown--;
                countdownElement.textContent = "Preusmeritev bo čez " + countdown + " sekund.";
    ...
    <div class="skupi">
        ...
        <div class="button-container">
            <form action="index.php" method="post">
                <button id="gumb" type="submit">Nova igra</button>
            </form>
            <br>
            <p class="majse crke">Preusmerjanje nazaj na začetno stran čez <span id="countdown">10 sekund</span>.</p>
        </div>
